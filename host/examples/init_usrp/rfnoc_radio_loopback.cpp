...
int UHD_SAFE_MAIN(int argc, char* argv[])
{
    ...
    desc.add_options()
        ("help", "help message")
        ("args", po::value<std::string>(&args)->default_value("addr=192.168.40.2,master_clock_rate=200e6"), "UHD device address args")
        ...
        ("rx-gain", po::value<double>(&rx_gain)->default_value(70), "Rx RF center gain in Hz")
        ("tx-gain", po::value<double>(&tx_gain)->default_value(70), "Tx RF center gain in Hz")
        ...
        ("rate", po::value<double>(&rate)->default_value(100e6), "Sampling rate")
